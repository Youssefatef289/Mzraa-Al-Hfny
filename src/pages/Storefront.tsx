...
import { ArrowUp, MessageSquare, PhoneCall, Heart, Award, Facebook, Home, Store, ShoppingBag, Phone, CheckCircle2 } from 'lucide-react';
...
export default function Storefront() {
  ...
  const handleAddToCart = (product: Product, quantity: number) => {
    ...
    saveCartToStorage({ ...cart, [key]: currentQty + quantity });
  ...
  const handleUpdateQty = (cartKey: string, quantity: number) => {
    ...
    saveCartToStorage({ ...cart, [cartKey]: quantity });
  };
  ...
  const handleClearCart = () => saveCartToStorage({});
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 items-start">
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-xl font-black text-white">مزارع الحفني</span>
              </div>
