...
export const CATEGORIES_INFO = [
  ...
  { id: 'processed', name: 'مصنعات لحوم', count: 14, desc: 'مصنعات بلدية محضرة من اللحوم الطازجة والبهارات الطبيعية الفاخرة بدون الصويا ومخلفات اللحوم والمواد الحافظة الضارة.' },
  ...
  { id: 'cheese', name: 'الجبن والمشتقات', count: 50, desc: 'تشكيلة جبن بلدي ومستورد، لانشون، سلامي، بسطرمة، مش وقشطة — تُباع بالوزن: ثمن، ربع، نص أو كيلو.' },
] as const;
...
export const PRODUCTS: Product[] = [
  ...
  {
    id: 'proc-14', name: 'كوبيبه شامى', description: 'كوبيبه شامي محضرة من اللحم البلدي الطازج والبرغل والبهارات، جاهزة للقلي المقرمش على الطريقة الشامية الأصيلة.',
    price: 300, unit: 'كيلو جرام', image: `${IMG}/قسم مصنعات اللحوم/كوبيبه شامى 300.jpeg`, category: 'processed', rating: 4.9, isAvailable: true, tag: 'جاهزة للقلي',
  },
  ...
  {
    id: 'cheese-48', name: 'حلاوة سادة', description: 'حلاوة طحينية سادة طازجة بنكهة طحينة أصيلة، تُباع بالوزن حسب اختيارك.',
    price: 125, unit: 'كيلو جرام', image: `${IMG}/قسم الجبن/حلاوه ساده 125.jpeg`, category: 'cheese', rating: 4.8, isAvailable: true,
  },
  {
    id: 'cheese-49', name: 'حلاوة بالسوداني', description: 'حلاوة طحينية بالفول السوداني محضرة طازجة، طعم غني ومقرمش يُباع بالوزن.',
    price: 135, unit: 'كيلو جرام', image: `${IMG}/قسم الجبن/حلاوه بالسودانى 135.jpeg`, category: 'cheese', rating: 4.8, isAvailable: true,
  },
  {
    id: 'cheese-50', name: 'جبنه ميسدام هولندى', description: 'جبنة ميسدام هولندية أصيلة بنكهة كريمية غنية، مثالية للساندويتشات والوجبات.',
    price: 650, unit: 'كيلو جرام', image: `${IMG}/قسم الجبن/جبنه ميسدام هولندى 650.jpeg`, category: 'cheese', rating: 4.8, isAvailable: true, tag: 'فاخر',
  },
];
