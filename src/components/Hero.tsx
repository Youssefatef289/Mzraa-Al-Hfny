  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-slate-950/90 via-brand-dark/40 to-brand-dark/50" />
      </div>

      {/* Hero Content — centered */}
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32 w-full flex flex-col items-center text-center text-white">
        {/* Badge */}
        <motion.div
        ...
        <motion.div
          ...
          className="grid grid-cols-3 gap-3 sm:gap-8 mt-16 pt-8 border-t border-white/10 w-full max-w-2xl"
        >
